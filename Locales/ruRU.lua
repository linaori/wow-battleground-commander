...
L['Queue paused for %s'] = 'Очередь остановлена %s'
L['Queue resumed for %s'] = 'Очередь возобновлена'
...
L['{leader} will be replaced by the leader name in this message and is optional'] = '{лидер} будет заменено на имя лидера в данном сообщении. Это опционально.'
